...
begin
	...
	insert into "order" ("order_id", "customer_id", "total_amount", "table_number", "branch_id", "order_status", "placed_time", "waiter_id", "kitchen_staff_id") values
		...
		(order7, userId1, 5000, 1, branchId1, 'Served', '2021-11-06 04:00:00.000', userId3, userId2),
		(order8, userId1, 6000, 1, branchId1, 'Served', '2021-11-06 12:00:00.000', userId3, userId2),
		(order9, userId1, 7000, 1, branchId1, 'Served', '2021-11-06 20:00:00.000', userId3, userId2),
		(order10, userId1, 24000, 1, branchId1, 'Served', '2021-11-06 23:00:00.000', userId3, userId2),
		(order11, userId1, 20000, 1, branchId2, 'Served', '2021-11-01 08:00:00.000', userId3, userId2),
		(order12, userId1, 3000, 1, branchId2, 'Served', '2021-11-06 08:00:00.000', userId3, userId2),
		...
		(order17, userId1, 5000, 1, branchId2, 'Served', '2021-11-06 04:00:00.000', userId3, userId2),
		(order18, userId1, 6000, 1, branchId2, 'Served', '2021-11-06 12:00:00.000', userId3, userId2),
	...
	insert into "booking" ("booking_id", "customer_id", "arrival", "departure", "placed_time", "status") values
		...
		(booking7, userId1, '2021-11-01 08:00:00.000', '2021-11-01 08:00:00.000', '2021-11-06 04:00:00.000', 'Completed'),
		(booking8, userId1, '2021-11-01 08:00:00.000', '2021-11-01 08:00:00.000', '2021-11-06 12:00:00.000', 'Completed'),
		(booking9, userId1, '2021-11-01 08:00:00.000', '2021-11-01 08:00:00.000', '2021-11-06 20:00:00.000', 'Completed'),
		(booking10, userId1, '2021-11-01 08:00:00.000', '2021-11-01 08:00:00.000', '2021-11-06 23:00:00.000', 'Completed'),
		(booking11, userId1, '2021-11-01 08:00:00.000', '2021-11-01 08:00:00.000', '2021-11-01 08:00:00.000', 'Completed'),
		(booking12, userId1, '2021-11-01 08:00:00.000', '2021-11-01 08:00:00.000', '2021-11-06 08:00:00.000', 'Completed'),
