...
begin
	...
	insert into "order" ("order_id", "customer_id", "total_amount", "table_number", "branch_id", "order_status", "placed_time", "waiter_id", "kitchen_staff_id") values
		(order1, userId1, 20000, 1, branchId1, 'Closed', '2021-11-01 08:00:00.000', userId3, userId2),
		(order2, userId1, 3000, 1, branchId1, 'Closed', '2021-11-11 08:00:00.000', userId3, userId2),
		(order3, userId1, 4000, 1, branchId1, 'Closed', '2021-11-16 08:00:00.000', userId3, userId2),
		(order4, userId1, 23000, 1, branchId1, 'Closed', '2021-11-21 08:00:00.000', userId3, userId2),
		(order5, userId1, 2200, 1, branchId1, 'Closed', '2021-11-26 08:00:00.000', userId3, userId2),
		(order6, userId1, 20100, 1, branchId1, 'Closed', '2021-11-27 08:00:00.000', userId3, userId2),
		(order7, userId1, 5000, 1, branchId1, 'Closed', '2021-11-11 04:00:00.000', userId3, userId2),
		(order8, userId1, 6000, 1, branchId1, 'Closed', '2021-11-11 12:00:00.000', userId3, userId2),
		(order9, userId1, 7000, 1, branchId1, 'Closed', '2021-11-11 20:00:00.000', userId3, userId2),
		(order10, userId1, 24000, 1, branchId1, 'Closed', '2021-11-11 23:00:00.000', userId3, userId2),
		(order11, userId1, 20000, 1, branchId2, 'Closed', '2021-11-01 08:00:00.000', userId3, userId2),
		(order12, userId1, 3000, 1, branchId2, 'Closed', '2021-11-11 08:00:00.000', userId3, userId2),
		(order13, userId1, 4000, 1, branchId2, 'Closed', '2021-11-16 08:00:00.000', userId3, userId2),
		(order14, userId1, 23000, 1, branchId2, 'Closed', '2021-11-21 08:00:00.000', userId3, userId2),
		(order15, userId1, 2200, 1, branchId2, 'Closed', '2021-11-26 08:00:00.000', userId3, userId2),
		(order16, userId1, 20100, 1, branchId2, 'Closed', '2021-11-27 08:00:00.000', userId3, userId2),
		(order17, userId1, 5000, 1, branchId2, 'Closed', '2021-11-11 04:00:00.000', userId3, userId2),
		(order18, userId1, 6000, 1, branchId2, 'Closed', '2021-11-11 12:00:00.000', userId3, userId2),
		(order19, userId1, 7000, 1, branchId2, 'Closed', '2021-11-03 20:00:00.000', userId3, userId2),
		(order20, userId1, 24000, 1, branchId2, 'Closed', '2021-11-03 23:00:00.000', userId3, userId2);
